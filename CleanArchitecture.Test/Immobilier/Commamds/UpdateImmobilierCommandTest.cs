...
namespace CleanArchitecture.Test.Immobilier.Commamds
{
    public class UpdateImmobilierCommandTest
    {
        ...
        {
            //Arrange
            _repositoryMock.Setup(r => r.UpdateAsync(It.IsAny<Entity.Immobilier>()))
            ...
            var request = new UpdateImmobilierCommand(new ImmobilierDto { Prix = 12345, Publier = true });
            ...
            _mapperMock.Verify(x => x.Map<Entity.Immobilier>(It.IsAny<ImmobilierDto>()), Times
                .Once);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<Entity.Immobilier>()), Times.Once);
        ...
        public async Task Handle_InvalideData_ShouldNotUpdate()
        {
            ...
            _mapperMock.Verify(x => x.Map<Entity.Immobilier>(It.IsAny<ImmobilierDto>()), Times
                .Never);
            _repositoryMock.Verify(r => r.UpdateAsync(It.IsAny<Entity.Immobilier>()), Times.Never);
